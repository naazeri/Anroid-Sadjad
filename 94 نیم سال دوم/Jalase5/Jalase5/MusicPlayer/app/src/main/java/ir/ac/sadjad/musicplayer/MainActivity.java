...
//        colorAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    private void loadImage(int imageAddress, ImageView imageView) {
//        imageView.setImageResource(imageAddress);  // src
//        imageView.setBackgroundResource(imageAddress);  // background
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.main_button_setPic1:
                loadImage(R.drawable.image01, image);
                break;
            case R.id.main_button_setPic2:
                loadImage(R.drawable.image05, image);
                break;
            case R.id.main_button_setPic3:
                loadImage(R.drawable.image10, image);
                break;
